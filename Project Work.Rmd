...
#dbeta(pi, 8.700102, 163)*dbinom(8, 170, pi)/dbeta(pi, 0.700102, 1)

posterior_median_pi <- qbeta(0.5, 8.700102, 163)
posterior_median_pi
qbeta(p=c(0.025,0.975), 8.700102, 163)
...
p_y_less_than_y0 <- pbeta(pi_0, 8.700102, 163)

# Calculate P(x < 0.3 | t) by substituting the calculated value of P(y < y0 | t)
p_x_less_than_0.3 <- p_y_less_than_y0
