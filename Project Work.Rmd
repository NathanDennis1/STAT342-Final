...
We can construct a Poisson prior using the previous binomial distribution defined as $T \sim Binom(170, \pi)$.
...
p1 <- ggplot(data=boot_sim_psi, 
  ...
  labs(title="Histogram of 100,000 Bootstrapped Vaccine Efficacy Rates",x="VE",y="Count")+
  xlim(0, 1)
