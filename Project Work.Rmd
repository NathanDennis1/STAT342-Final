...
A gamma distribution is convenient choice for the prior of the parameter $\lambda$. The prior would follow Gamma($170, \pi_0$), as the shape parameter would represent the total number of confirmed cases and the rate parameter would represent the rate of
