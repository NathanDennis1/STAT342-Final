...
\begin{align*}
L(\psi) &= L(\frac{\hat \pi_p-\hat \pi_v}{\hat \pi_p})\\
&= f(\hat \pi_p, \hat \pi_v | \psi) \\
&= ??
\end{align*}
...
&= {170\choose t} (\frac{1 -\psi}{2-\psi})^t \cdot (1 - \frac{1 -\psi}{2-\psi})^{170-t} \\
...
&= ln{170\choose t} + tln(\frac{1 -\psi}{2-\psi}) + (170-t)ln(\frac{1}{2-\psi}) \\
\end{align*}

Derivative and set to 0

\begin{align*}
\frac{d}{d\psi} ln(L(\psi)) &= \frac{d}{d\psi} ln(f(t | \psi)) \\
&= \frac{d}{d\psi} ln{170\choose t} + tln(\frac{1 -\psi}{2-\psi}) + (170-t)ln(\frac{1}{2-\psi}) \\
...
\begin{align*}
\frac{d}{d\psi} ln(L(\psi)) &= \frac{d}{d\psi} ln(f(t | \psi)) \\
&= \frac{d}{d\psi} ln{170\choose t} + tln(\pi) + (170-t)ln(1 - \pi) \\
0 &= \frac{t}{\pi} - \frac{170-t}{1-\pi} \\
0 &= \frac{8}{\pi} - \frac{170-8}{1-\pi} \ \ \text{Plug in t obs} \\
\frac{162}{1-\pi} &= \frac{8}{\pi} \\
\frac{162}{8} &= \frac{1-\pi}{\pi} \\
\frac{162}{8} &= \frac{1}{\pi} - 1 \\
\frac{162}{8} + 1 &= \frac{1}{\pi} \\
\pi &= \frac{1}{\frac{162}{8} + 1} \\
\end{align*}
